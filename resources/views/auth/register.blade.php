            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Apstiprini paroli') }}</label>
                        ...
                        <div class="form-group row mb-0">
                                ...
                                <div class="col-md-4 text-md-right">
                                        <a class="btn btn-outline-primary" href="{{ route('login') }}">{{ __('Pierakstīšanās Lapa') }}</a>      
                                </div>
